...
var stripe = Stripe('pk_test_51IiO5MSDYL41xcuSBydjlawnERZkKhRex2SgSXRaGYaMTKkVFNg6D4zvI9YaUFvSRgZJSMwwL6hyj96dlwUVMSbu00dwhYWG2w');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logging In! Please wait...');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt("return", location.assign('/login'));
          ...
          case 11:
            ...
            (0, _alerts.showAlert)('error', 'Log out failed. please try again!');
...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FpcmFta3Jpc2huYSIsImEiOiJja25tM2lxZWkwbnlkMnFtcG1wb2Zic2V2In0.a_3CKgAtPMcPQVOBG-WG1Q';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // 2)create marker

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // 3)create popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // 4)extend bounds
...
},{}],"userSettings.js":[function(require,module,exports) {
"use strict";
...
function userSettings(_x, _x2) {
  return _userSettings.apply(this, arguments);
}

function _userSettings() {
  _userSettings = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    console.log("email: ".concat(email, " pass: ").concat(password));
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _userSettings.userSettings)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _userSettings.userSettings)({
                password: password,
...
if (bookTourButton) {
  bookTourButton.addEventListener('click', function (e) {
    ...
    var tourID = bookTourButton.dataset.tourid;
